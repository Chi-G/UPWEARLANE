  ...
  return (
    <Card className="border-primary/20 bg-primary/5 hover:border-primary/40 transition-all duration-300">
      <CardHeader>
        <div className="flex items-center gap-3 mb-2">
          <div className="p-2 bg-green-500 rounded-lg">
             {/* Using a custom SVG for WhatsApp for better brand recognition */}
             <svg 
          ...
          <CardTitle className="text-xl font-bold">WhatsApp Support</CardTitle>
        </div>
      ...
      <CardContent className="space-y-4">
        ...
        <Button 
          className="w-full bg-green-500 hover:bg-green-600 text-white gap-2 h-12 text-lg transition-all duration-300"
