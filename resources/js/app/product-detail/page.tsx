    ...
    const reviewsData = [
        {
            ...
            userImage:
                'https://img.rocket.new/generatedImages/rocket_gen_img_10a538b25-1763292461340.png',
            userImageAlt:
                'Professional headshot of Marcus Johnson, African American man in business attire',
            rating: 5,
        ...
        },
        {
            ...
            userName: 'Sarah Chen',
            userImage:
                'https://images.unsplash.com/photo-1668049221564-862149a48e10',
            userImageAlt:
                'Portrait of Sarah Chen, Asian woman with long black hair smiling outdoors',
            rating: 4,
        ...
        },
        {
            ...
            userImage:
                'https://img.rocket.new/generatedImages/rocket_gen_img_1e6bc1b96-1763295423974.png',
            userImageAlt:
                'Casual photo of David Martinez, Hispanic man with beard wearing casual clothing',
            rating: 5,
        ...
        },
        {
            ...
            userImage:
                'https://img.rocket.new/generatedImages/rocket_gen_img_10c652490-1763297183972.png',
            userImageAlt:
                'Professional portrait of Emily Thompson, Caucasian woman with blonde hair',
            rating: 5,
    ...
    const relatedProductsData = [
        {
            ...
            description:
                'A versatile heated vest for core warmth in variable conditions.',
            isNew: false,
            discount: 25,
        },
        {
            ...
            description:
                'High-performance hoodie with integrated biometric sensors.',
            isNew: true,
        },
        {
            id: 4,
            ...
            description:
                'Ultra-lightweight windbreaker for runners who demand the best.',
            isNew: false,
            discount: 22,
        },
        {
            ...
            description:
                'Minimalist windbreaker with advanced urban protection.',
            isNew: false,
        },
        {
            id: 6,
            ...
            description:
                'Extreme protection for the coldest urban environments.',
            isNew: true,
            discount: 22,
        },
    ];
