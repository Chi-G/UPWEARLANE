    ...
    const products = [
        {
            ...
            description:
                'Temperature-regulating smart jacket with integrated heating elements and moisture-wicking technology for optimal comfort in any weather.',
        ...
        },
        {
            ...
            description:
                'Stunning evening gown featuring programmable LED fiber optics that create mesmerizing light patterns controlled via smartphone app.',
        ...
        },
        {
            ...
            description:
                'Advanced compression shirt with embedded biometric sensors that track heart rate, breathing patterns, and muscle activity in real-time.',
        ...
        },
        {
            ...
            description:
                'Innovative backpack with integrated solar panels that charge your devices on the go, featuring multiple USB ports and weather-resistant design.',
        ...
        },
        {
            ...
            description:
                'Professional gaming gloves with advanced haptic feedback technology providing tactile sensations for immersive VR and gaming experiences.',
        ...
        },
        {
            ...
            description:
                'High-performance running shorts with climate-adaptive fabric that adjusts breathability based on body temperature and environmental conditions.',
            colors: ['#000000', '#001F3F', '#4D4D4D'],
            brand: 'smartwear',
        },
        {
            ...
            description:
                'Cutting-edge smart glasses featuring augmented reality display, voice control, and seamless smartphone integration for hands-free navigation.',
        ...
        },
        {
            ...
            description:
                'Intelligent vest with posture-monitoring sensors that provide gentle vibration feedback to help maintain proper spinal alignment throughout the day.',
        ...
        },
        {
            ...
            description:
                "Stylish hat with built-in UV sensors that monitor sun exposure and alert you via smartphone when it's time to seek shade or reapply sunscreen.",
        ...
        },
        {
            ...
            description:
                'Advanced leggings with phase-change materials that actively regulate body temperature, keeping you comfortable during intense workouts or cold weather.',
        ...
        },
        {
            ...
            description:
                'Fashionable belt with integrated wireless charging technology, allowing you to charge compatible devices simply by placing them near your waist.',
        ...
        },
        {
            ...
            description:
                'Compression sleeves with embedded EMS technology that accelerate muscle recovery through targeted electrical stimulation after workouts.',
