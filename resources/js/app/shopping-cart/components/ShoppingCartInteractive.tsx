...
export default function ShoppingCartInteractive({ initialCartData }: ShoppingCartInteractiveProps) {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
      ...
      <div className="lg:col-span-2 space-y-4">
        ...
        <div className="lg:hidden">
          <PromoCodeSection onApplyPromo={handleApplyPromo} appliedPromo={appliedPromo} />
        </div>
      </div>
